...
One line, directly above the closing frame:
     ...
     read: 3 files · truth: used

Files opened to fold the spec in — the spec, explore.md, and each truth file
touched. `truth: used` here almost always, since folding into truth means
reading the truth files being folded into.
